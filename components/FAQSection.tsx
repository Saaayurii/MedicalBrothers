  ...
  const faqs = [
    {
      ...
      answer: 'Система использует Web Speech API для распознавания вашей речи и преобразует её в текст. Затем медицинский ассистент анализирует запрос, определяет намерение и генерирует ответ. Ответ озвучивается с помощью синтеза речи.',
    },
    {
