...
> Интеллектуальный голосовой помощник для медицинской клиники с AI-консультациями и автоматической записью на приём

[![Next.js](https://img.shields.io/badge/Next.js-16-black)](https://nextjs.org/)
[![React](https://img.shields.io/badge/React-19-blue)](https://react.dev/)
[![TypeScript](https://img.shields.io/badge/TypeScript-5-blue)](https://www.typescriptlang.org/)
[![PostgreSQL](https://img.shields.io/badge/PostgreSQL-16-blue)](https://www.postgresql.org/)
[![Ollama](https://img.shields.io/badge/Ollama-Qwen_2.5-green)](https://ollama.ai/)

## 📋 Обзор

Medical Voice Assistant - это современная система для медицинских клиник, которая использует голосовое взаимодействие и искусственный интеллект для:

- 📅 **Записи на приём** - автоматическая запись к врачам с проверкой доступности
- 🩺 **AI-консультации** - предварительная оценка симптомов с рекомендациями
