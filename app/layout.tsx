...
export const metadata: Metadata = {
  ...
  description: 'Интеллектуальный голосовой помощник для медицинской клиники с AI-консультациями, записью на приём и экстренными вызовами. Работает на Next.js 16 и медицинском AI.',
  keywords: ['медицинская клиника', 'голосовой помощник', 'AI', 'запись к врачу', 'телемедицина', 'консультация онлайн', 'медицинский ассистент', 'Next.js'],
